export const projects = {
    sectionTitle: '',
    icon: null,
    description: 'Projects, i have completed & participated are listed below. To get general information about private project or not-finished projects you can get in touch.',
    categories: [
      {
        name: 'JotForm',
        list: [{
